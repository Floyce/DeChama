        ...
        <Box py={10}>
            <Container maxW="container.xl">
                ...
                <Flex justify="space-between" align="center" mb={10}>
                    <Box>
                        <Heading size="lg" mb={2}>Welcome back, {address?.slice(0, 5)}...</Heading>
                        <Text color="gray.500">Here is what is happening in your Chama.</Text>
                    </Box>
                    <Button leftIcon={<FaPlus />} colorScheme="purple">Make Contribution</Button>
                </Flex>
                ...
                <Grid templateColumns={{ base: '1fr', lg: '2fr 1fr' }} gap={8}>
                        ...
                        <Card mb={8}>
                            <CardBody>
                                ...
                                <Flex justify="space-between" fontSize="sm" color="gray.500">
                                    <Text>Jan</Text>
                                    <Text>Feb</Text>
                                    <Text fontWeight="bold" color="primary.main">Mar (Now)</Text>
                                    <Text>Apr</Text>
                                    <Text>May</Text>
                                </Flex>
                            </CardBody>
                    ...
                    <GridItem>
                        ...
                        <VStack spacing={4}>
                            <Button w="full" leftIcon={<FaPlus />} variant="solid" height="3.5rem">Make Contribution</Button>
